...
namespace ColorInvestigation.Common
{
    public class XColorSpaces
    {
        ...
        public static double GetGrayLevel(XRGB rgb) => XYCbCr.GetGrayLevel(rgb);
        ...
        /// <returns></returns>
        public static bool IsDarkColor(Color color) => GetGrayLevel(new XRGB(color)) < DarkSplit;
        ...
        {
            var hsv = new XHSV(new XRGB(color));
        ...
        public class XRGB
        {
            ...
            public XRGB(double r, double g, double b)
            {
                R = r; G = g; B = b;
            }

            public XRGB(Color color)
            {
        ...
        public class XHSL
        {
            ...
            public XHSL(double h, double s, double l)
            {
                H = h; S = s; L = l;
            }
            public XHSL(XRGB rgb)
            {
            ...
            public XRGB RGB
            {
                ...
                {
                    if (is_equal(S, 0.0))
                        return new XRGB(L, L, L); // achromatic
        ...
        public class XHSV
        {
            ...
            public XHSV(double h, double s, double v)
            {
                H = h; S = s; V = v;
            }
            public XHSV(XRGB rgb)
            {
                var max = threeway_max(rgb.R, rgb.G, rgb.B);
                var min = threeway_min(rgb.R, rgb.G, rgb.B);
                var d = max - min;
            ...
            public XRGB RGB
            {
                get
                {
                    ...
                    switch (i % 6.0)
                    {
                        case 0: return new XRGB(V, t, p);
                        case 1: return new XRGB(q, V, p);
                        case 2: return new XRGB(p, V, t);
                        case 3: return new XRGB(p, q, V);
                        case 4: return new XRGB(t, p, V);
                        case 5: return new XRGB(V, p, q);
                    }
        ...
        public class XXYZ
        {
            ...
            public XXYZ(double x, double y, double z)
            {
                X = x; Y = y; Z = z;
            }

            public XXYZ(XRGB rgb)
            {
        ...
        public class XLAB
        {
            ...
            public XLAB(double l, double a, double b)
            {
                L = l; A = a; B = b;
            }
            public XLAB(XRGB rgb) : this(new XXYZ(rgb)) { }

            public XLAB(XXYZ xyz)
            {
                ...
                {
                    {
                        ...
                        return new XXYZ(xyzX, xyzY, xyzZ);
                    }
                }
            }
            ...
            private static XXYZ XyzWhiteReference => new XXYZ(95.047, 100.000, 108.883);
        ...
        public class XYCbCr
        {
            ...
            public XYCbCr(double y, double cB, double cR, YCbCrStandard standard = DefaultYCbCrStandard)
            {
                Y = y; Cb = cB; Cr = cR;
                Standard = standard;
            }
            public XYCbCr(XRGB rgb, YCbCrStandard standard = DefaultYCbCrStandard)
            {
            ...
            public static double GetGrayLevel(XRGB rgb)
            {
