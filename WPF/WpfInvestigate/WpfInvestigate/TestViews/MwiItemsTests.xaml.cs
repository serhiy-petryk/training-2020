...
{
    /// <summary>
    /// Interaction logic for MwiItemsTests.xaml
    /// </summary>
    public partial class MwiItemsTests : Window
    {
        public MwiItemsTests()
        {
            InitializeComponent();
        }
        ...
        {
            var mwiContainer = ((MwiItemsTests)Application.Current.Windows.OfType<Window>().SingleOrDefault(x => x.IsActive))?.MwiContainer;
