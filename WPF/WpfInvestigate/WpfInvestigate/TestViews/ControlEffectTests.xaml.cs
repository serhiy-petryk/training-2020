...
namespace WpfInvestigate.TestViews
{
    ...
    public partial class ControlEffectTests : Window
    {
        ...
        private void ChangeColor_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            ControlEffects.SetMonochromeAnimated(AnimatedTestButtonWhite, new SolidColorBrush(color));
            ControlEffects.SetMonochromeAnimated(AnimatedTestButtonBlack, new SolidColorBrush(color));
        }
    }
}
