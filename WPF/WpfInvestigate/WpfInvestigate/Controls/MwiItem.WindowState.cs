    ...
    public partial class MwiItem
    {
        ...
        private async void ToggleDetach(object obj)
        {
            ...
            if (IsWindowed)
            {
                ...
                wnd.Close();
                wnd.Content = null;
                MwiItems.MwiPanel.Children.Add(this);
            ...
            else
            {
                ...
                MwiItems.MwiPanel.Children.Remove(this);
                ...
                MwiItems.ScrollViewer.HorizontalScrollBarVisibility = ScrollBarVisibility.Auto;
                MwiItems.ScrollViewer.VerticalScrollBarVisibility = ScrollBarVisibility.Auto;
        ...
        private static void OnWindowStateValueChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e) =>
            ((MwiItem)sender).WindowStateValueChanged((WindowState)e.NewValue, (WindowState)e.OldValue);
