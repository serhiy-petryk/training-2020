...
namespace MyWpfMwi.Useful
{
    // taken from https://www.codeproject.com/Articles/57175/WPF-How-To-Animate-Visibility-Property
    // Дуже цікаво і просто, але не завжди можна використати, наприклад, якщо визиваємо Close()
    ...
    public class VisibilityAnimation
    {
        ...
        /// </summary>
        public static readonly DependencyProperty AnimationTypeProperty = DependencyProperty.RegisterAttached("AnimationType", typeof(AnimationType), typeof(VisibilityAnimation), new FrameworkPropertyMetadata(AnimationType.None, OnAnimationTypePropertyChanged));
                ...
                else
                {
                    ...
                    if (BindingOperations.IsDataBound(frameworkElement, UIElement.VisibilityProperty))
                    {
                        ...
                        Binding bindingValue =
                            BindingOperations.GetBinding(frameworkElement, UIElement.VisibilityProperty);
