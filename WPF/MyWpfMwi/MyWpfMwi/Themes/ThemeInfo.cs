...
namespace MyWpfMwi.Themes
{
    public class ThemeInfo
    {
        public static ThemeInfo[] Themes =
        {
            new ThemeInfo("Windows10", "Стиль Windows 10", null, new[] { "/Themes/Wnd7.xaml"}),
            new ThemeInfo("Windows7", "Стиль Windows 7", null, new[] { "/Themes/Wnd10.xaml"})
            /*new ThemeInfo("Windows10", "Стиль Windows 10", null, new[] { "/Mwi/Themes/MwiChild.Wnd10.xaml", "/Themes/MwiContainer.Wnd7.xaml"}),
            new ThemeInfo("Windows7", "Стиль Windows 7", null, new[] { "/Mwi/Themes/MwiChild.Wnd7.xaml", "/Themes/MwiContainer.Wnd7.xaml"})*/
        };
        ...
        public ThemeInfo(string id, string name, string assemblyName, string[] uris)
        {
            Id = id;
            Name = name;
